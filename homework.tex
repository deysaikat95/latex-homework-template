...
\newcommand{\hmwkClass}{Advanced Machine Learning}
%\newcommand{\hmwkClassTime}{Section A}
\newcommand{\hmwkClassInstructor}{Professor Bert Huang}
\newcommand{\hmwkAuthorName}{\textbf{Sonal Jha} \and \textbf{Saikat Dey}}
